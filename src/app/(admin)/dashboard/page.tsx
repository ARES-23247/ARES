    ...
    <div className="w-full max-w-5xl mx-auto px-6 py-12 md:py-24">
      ...
      <div className="mb-12">
        ...
        <p className="text-white/60 max-w-2xl text-balance">
          Draft and commit new engineering and outreach blog posts directly to the ARES 23247 D1 Database using the internal Tiptap integration. All content is stored natively at the Edge.
        </p>
      </div>
