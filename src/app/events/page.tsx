...
// Mock JSON fetching function, totally edge compatible
async function fetchMockEvents() {
  ...
  return [
    {
      id: 1,
      title: "Design Requirements Review",
      date: "2026-03-02",
      type: "Team Meeting",
      description: "Full team review of subsystem requirements before CAD lock.",
      color: "bg-blue-500/20 text-blue-400 border-blue-500/30"
    },
    {
      id: 2,
      title: "STEM Night Outreach",
      date: "2026-03-08",
      type: "Outreach",
      description: "Demonstrating our driver station and chassis at the local middle school.",
    ...
    },
    {
      ...
      date: "2026-03-12",
      type: "Qualifier",
      description: "Our first major competition event. Loading out starts Thursday morning.",
      color: "bg-ares-red/20 text-ares-red border-ares-red/30"
    },
    {
      id: 4,
      title: "Programming Subsystem Testing",
      date: "2026-03-18",
      type: "Team Meeting",
      description: "Testing path planner autonomous routines on the practice field.",
      color: "bg-blue-500/20 text-blue-400 border-blue-500/30"
    },
    {
      id: 5,
      ...
      date: "2026-04-03",
      type: "Qualifier",
      description: "The ultimate showdown. Let's aim for Einstein!",
      color: "bg-ares-cyan/20 text-ares-cyan border-ares-cyan/30"
    }
  ];
}
