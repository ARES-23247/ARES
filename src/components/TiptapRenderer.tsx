...
const SwerveSimulator = lazy(() => import('./SwerveSimulator'));
const SOTMSimulator = lazy(() => import('./SOTMSimulator'));
const ConfigVisualizer = lazy(() => import('./docs/ConfigVisualizer'));
const ScreenshotGallery = lazy(() => import('./docs/ScreenshotGallery'));
const FaultSim = lazy(() => import('./FaultSim'));
const PhysicsSim = lazy(() => import('./PhysicsSim'));
const SysIdSim = lazy(() => import('./SysIdSim'));
const VisionSim = lazy(() => import('./VisionSim'));
const ZeroAllocationSim = lazy(() => import('./ZeroAllocationSim'));
const FieldVisualizer = lazy(() => import('./FieldVisualizer'));
const TroubleshootingWizard = lazy(() => import('./TroubleshootingWizard'));
const PerformanceDashboard = lazy(() => import('./PerformanceDashboard'));
const ArmKgSim = lazy(() => import('./ArmKgSim'));
const AutoSim = lazy(() => import('./AutoSim'));
const ElevatorPidSim = lazy(() => import('./ElevatorPidSim'));
const FlywheelKvSim = lazy(() => import('./FlywheelKvSim'));
const PowerSheddingSim = lazy(() => import('./PowerSheddingSim'));
const StateMachineSim = lazy(() => import('./StateMachineSim'));
