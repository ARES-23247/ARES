    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-[400px] w-full bg-ares-gray-deep text-white ares-cut-sm border border-dashed border-ares-danger/50 p-8 shadow-2xl">
          ...
          <div className="bg-ares-gray-dark border border-white/10 p-4 ares-cut-sm w-full max-w-xl text-left font-mono text-xs text-ares-danger-soft overflow-x-auto mb-8 shadow-inner">
            {this.state.errorStr}
          </div>
          <button 
