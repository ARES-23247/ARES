...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-4 md:top-6 left-0 w-full z-50 px-4 md:px-8 pointer-events-none flex justify-center">
      <nav className="pointer-events-auto w-full max-w-7xl bg-obsidian/85 backdrop-blur-xl shadow-2xl px-6 py-4 transition-all duration-500 overflow-hidden border border-white/10 hero-card group">
        <div className="flex items-center justify-between">
          ...
          >
            ARES <span className="text-ares-red font-bold group-hover:text-ares-gold transition-colors">23247</span>
          </button>
