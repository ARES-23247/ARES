        ...
        <div>
          ...
          <div className="grid grid-cols-10 gap-2 mb-8">
            ...
            <a href={`https://tiktok.com/@${siteConfig.urls.tiktok}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center hover:bg-[#00f2ea] transition-all hover:-translate-y-1 text-white border border-white/5 shadow-xl" aria-label="TikTok">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.02 2.61-.31 3.91-.87V7.33c-.64.25-1.31.39-2.02.45a4.92 4.92 0 0 1-4.4-4.4c0-.3.04-.59.11-.87.54v-3.1a7.96 7.96 0 0 0-4 1.02v8.7a6.96 6.96 0 0 0-6.96 6.96 6.96 0 0 0 6.96 6.96 6.96 0 0 0 6.96-6.96v-5.41a9.97 9.97 0 0 1-5.36 1.54v3.55c2.27-.38 4.54-.25 6.69.53a6.96 6.96 0 0 1 5.36 6.78c0 .39-.03.77-.09 1.14v-.04c-.08-3.61-3.06-6.52-6.72-6.52z"/></svg>
            </a>
