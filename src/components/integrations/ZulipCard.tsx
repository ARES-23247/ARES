  ...
  return (
    <div className="glass-card bg-black/40 p-6 ares-cut border border-blue-500/20 relative overflow-hidden group lg:col-span-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div>
          <label htmlFor="zulip_url" className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2">
            Organization URL
          </label>
          <input
            id="zulip_url"
            ...
            className="w-full bg-black/60 border border-white/10 ares-cut-sm px-4 py-3 text-white focus:outline-none focus:border-blue-400 transition-colors"
          />
        </div>
        <div>
          <label htmlFor="zulip_bot_email" className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2">
            Bot Email
          </label>
          <input
            id="zulip_bot_email"
        ...
        <div>
          <label htmlFor="zulip_api_key" className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2">
            API Key
          </label>
          <input
            id="zulip_api_key"
        ...
        <div>
          <label htmlFor="zulip_webhook_token" className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2">
        ...
        <div>
          <label htmlFor="zulip_admin_stream" className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2">
            Admin Stream
          </label>
          <input
        ...
        <div>
          <label htmlFor="zulip_comment_stream" className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2">
            Comment Stream
          </label>
          <input
