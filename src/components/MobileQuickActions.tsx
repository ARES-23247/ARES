              ...
              <div className="grid grid-cols-2 gap-4">
                {links.map((link) => (
                  <Link
                    ...
                    className="flex flex-col items-center justify-center p-6 bg-white/5 border border-white/5 rounded-2xl hover:bg-ares-red/10 hover:border-ares-red/20 transition-all group"
                  >
