...
INSERT INTO docs (slug, title, category, sort_order, description, content) VALUES ('tutorials-sotm', 'Elite Shooting (SOTM)', 'Tutorials', 37, 'Mastering Shoot-On-The-Move kinematics with physics-based compensation.', 'import SOTMSimulator from ''../../../components/SOTMSimulator.astro'';
